            ...
            <div className="alien-calculator">
                ...
                <div className="footer-actions" style={{ marginTop: '24px', padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px', backgroundColor: 'white' }}>
                    <div style={{ display: 'flex', gap: '16px' }}>
                        <button className="btn-share" style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '12px', borderRadius: '8px', border: '1px solid #e5e7eb', backgroundColor: 'white', cursor: 'pointer', height: '100px' }}>
